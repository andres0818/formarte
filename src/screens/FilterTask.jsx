  ...
  return (
    <View className="">
      <View className="flex  items-center px-8 ">
        <Image className="absolute w-full h-full rounded-md" source={fondoFiltro} />
        ...
        <View className="w-full px-8 mt-6 mb-8 ">
          <TextInput
            ...
            className="bg-white w-full h-16 px-4 font-bold text-sm border-y-stone-500 border rounded-t-lg"
          />
          <TextInput
            placeholder="Ciudad"
            className="bg-white w-full h-16 px-4 font-bold text-sm border-y-stone-500 border"
          />
          <TextInput
          ...
          <TextInput
            ...
            className="bg-white w-full h-16 px-4 font-bold text-sm border-y-stone-500 border rounded-b-lg"
          />
